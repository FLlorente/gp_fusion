...
from .common import vmap_SE_kernel, matmul_vmapped, vdivide, vmap_SE_kernel_fer
...
'''
bhs without noise in the GPs
'''

def bhs_without_noise(X, mu_preds, std_preds, y_val=None):
    N, M = mu_preds.shape
